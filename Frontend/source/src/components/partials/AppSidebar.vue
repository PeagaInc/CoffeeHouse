    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        <li class="nav-item nav-profile">
          <div class="nav-link">
            <div class="profile-image"> <img src="../../assets/images/faces/chipchip.jpg" alt="image"/> <span class="online-status online"></span> </div>
            <div class="profile-name">
              <p class="name">Huyenn Chipp</p>
        ...
        <li class="nav-item"><router-link class="nav-link" to="/orders"><img class="menu-icon" src="../../assets/images/menu_icons/order.png" alt="menu icon"><span class="menu-title">Food Order</span></router-link></li>
        <li class="nav-item"><router-link class="nav-link" to="/foods"><img class="menu-icon" src="../../assets/images/menu_icons/menu.png" alt="menu icon"><span class="menu-title">Food Category</span></router-link></li>
        <li class="nav-item"><router-link class="nav-link" to="/staffs"><img class="menu-icon" src="../../assets/images/menu_icons/staff.png" alt="menu icon"><span class="menu-title">Staff Manager</span></router-link></li>
